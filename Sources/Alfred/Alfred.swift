...
public class Alfred {
  ...
  static let appBundlePath: URL = fs.fileExists(atPath: "/Applications/Alfred 5.app") ? URL(fileURLWithPath: "/Applications/Alfred 5.app") : URL(fileURLWithPath: "/Applications/Alfred 4.app")
